...
ARG AUTHENTICATION_API_KEY=${AUTHENTICATION_API_KEY}
...
ARG AUTHENTICATION_JWT_SECRET=${AUTHENTICATION_JWT_SECRET}
ENV AUTHENTICATION_JWT_SECRET=${AUTHENTICATION_JWT_SECRET}
